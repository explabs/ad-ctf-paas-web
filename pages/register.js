...
function SignupPage() {
  ...
  const { control, setError, formState, handleSubmit } = useForm({
    mode: "onChange",
    defaultValues: {
      name: "",
      password: "",
        ...
        >
          <Grid item md={8}>
            <div className="card-wrapper">
              ...
              >
                <h3 style={{ marginBottom: 0, paddingBottom: "0.5rem" }}>
                  Регистрация
                </h3>
              </div>
                      ...
                      <div>
                        ...
                        <ul className="faq">
                          <li className="faq-item">
                            <a
                              className="faq-link"
                              href="https://selectel.ru/blog/tutorials/how-to-generate-ssh/"
                            >
